...
function validateEmail() {
    if (email.value.length < 1) {
        ...
        emailError.style.visibility = 'visible';
        emailError.innerHTML = "<p>Enter a valid email! Email must match xxxx@xxxx.xxx </p>";
        email.classList.add('wrong-input');
...
function validatePassword() {
    if (password.value.length < 6) {
        ...
        passwordError.innerHTML = "<p>Enter a valid password! Password must be at least 6 characters</p>";
